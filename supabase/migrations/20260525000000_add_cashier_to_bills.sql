-- ============================================================
-- Migration: Add cashier (staff) to bills
-- Records which staff member rang up each sale.
-- ============================================================
...
-- 2. Recreate save_bill_with_payment with cashier params
...
BEGIN
  ...
  -- 1. Insert bill (now with cashier)
  INSERT INTO bills (
